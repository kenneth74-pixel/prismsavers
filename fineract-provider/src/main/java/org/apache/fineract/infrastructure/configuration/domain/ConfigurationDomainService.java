...
public interface ConfigurationDomainService {
    ...
    boolean isClientSelfRegistrationEnabled();

    boolean isMonthlyStatementsEnabled();

    boolean isLoanAgingHistoryEnabled();

    boolean isSMSPasswordOTPEnabled();

    boolean usePrincipalProvisioning();

    long retrieveParentOrganisation();
