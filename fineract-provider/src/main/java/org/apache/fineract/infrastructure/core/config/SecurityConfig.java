...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http //
                ...
                .antMatchers(HttpMethod.POST, "/api/*/self/validate").permitAll() //
                .antMatchers(HttpMethod.POST, "/api/*/update-tenant").permitAll() //
                ...
                .and() //
                .headers().frameOptions().and().contentSecurityPolicy("frame-ancestors *").and().and() //
    ...
    public FilterRegistrationBean<TenantAwareBasicAuthenticationFilter> tenantAwareBasicAuthenticationFilterRegistration()
            throws Exception {
        FilterRegistrationBean<TenantAwareBasicAuthenticationFilter> registration = new FilterRegistrationBean<>(
