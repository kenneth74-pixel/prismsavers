...
public class ImagesApiResource {
    ...
    public Response retrieveImage(@PathParam("entity") final String entityName, @PathParam("entityId") final Long entityId,
        ...
        return this.retrieveImage(entityName, entityId, maxWidth, maxHeight, output, acceptHeader, false);
    }

    public Response retrieveImage(String entityName, Long entityId, Integer maxWidth, Integer maxHeight, String output, String acceptHeader,
            boolean isSelfUser) {
        if (!isSelfUser) {
            validateEntityTypeforImage(entityName);
