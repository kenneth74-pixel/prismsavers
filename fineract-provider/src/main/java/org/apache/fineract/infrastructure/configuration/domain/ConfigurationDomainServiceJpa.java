...
public class ConfigurationDomainServiceJpa implements ConfigurationDomainService {
    ...
    @Override
    public boolean isClientSelfRegistrationEnabled() {
        final String propertyName = "self-registration-client";
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(propertyName);
        return property.isEnabled();
    }

    @Override
    public boolean isMonthlyStatementsEnabled() {
        final String propertyName = "member-monthly-statements";
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(propertyName);
        return property.isEnabled();
    }

    @Override
    public boolean isSMSPasswordOTPEnabled() {
        final String propertyName = "sms-otp";
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(propertyName);
        return property.isEnabled();
    }
    ...
    public boolean isMFAEnabled() {
        final String propertyName = "Multi-Factor-Authentication";
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(propertyName);
        return property.isEnabled();
    }

    @Override
    public boolean usePrincipalProvisioning() {
        final String propertyName = "use-principal-provisioning";
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(propertyName);
        return property.isEnabled();
    }

    @Override
    public boolean isLoanAgingHistoryEnabled() {
        final String propertyName = "loan-arrears-aging-history";
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(propertyName);
        return property.isEnabled();
    }

    @Override
    public long retrieveParentOrganisation() {
        final String propertyName = "parent-organization";
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(propertyName);
