...
public class BulkImportEventListener implements ApplicationListener<BulkImportEvent> {
    ...
    public void onApplicationEvent(final BulkImportEvent event) {
        ...
        switch (entityType) {
            ...
            break;
            case FSP_LOAN_TRANSACTIONS:
                importHandler = this.applicationContext.getBean("loanTransactionsImportHandler", ImportHandler.class);
            break;
            ...
            break;
            case SELF_SERVICE_USERS:
                importHandler = this.applicationContext.getBean("selfServiceUserImportHandler", ImportHandler.class);
            break;
            case NEW_SAVINGS:
                importHandler = this.applicationContext.getBean("newSavingsImportHandler", ImportHandler.class);
            break;
            case NEW_SHARES:
                importHandler = this.applicationContext.getBean("newSharesImportHandler", ImportHandler.class);
            break;
            default:
