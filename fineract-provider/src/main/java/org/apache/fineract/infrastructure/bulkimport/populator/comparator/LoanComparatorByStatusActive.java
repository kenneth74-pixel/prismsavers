...
public class LoanComparatorByStatusActive implements Comparator<LoanAccountData> {
    ...
    public int compare(LoanAccountData o1, LoanAccountData o2) {
        ...
        // compare by client ID first because we want all the loans of a given client together
        if (!Objects.equals(o1.clientId(), o2.clientId())) {
            return Long.compare(o1.clientId(), o2.clientId());
        }
