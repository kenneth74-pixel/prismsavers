...
public class LoanTransactionsSheetPopulator extends AbstractWorkbookPopulator {
    ...
    public LoanTransactionsSheetPopulator(List<LoanProductData> products) {
    ...
    public void populate(Workbook workbook, String dateFormat) {
        ...
        for (LoanProductData product : products) {
            ...
            if (product.getInArrearsTolerance() != null) writeBigDecimal(IN_ARREARS_TOLERANCE_COL, row, product.getInArrearsTolerance());
