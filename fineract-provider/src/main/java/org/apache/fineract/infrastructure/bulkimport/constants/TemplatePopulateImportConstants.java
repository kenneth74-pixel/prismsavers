...
public final class TemplatePopulateImportConstants {
    ...
    public static final String NEW_SAVINGS_SHEET_NAME = "NewSavings";
    ...
    public static final String NEW_SHARES_SHEET_NAME = "NewShares";
    public static final String NEW_LOANS_SHEET_NAME = "NewLoans";
    ...
    public static final String SELF_SERVICE_USER_SHEET_NAME = "SelfServiceUsers";
