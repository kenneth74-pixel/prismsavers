...
public class AuthenticationApiResource {
    ...
    private final LicenseUsageValidator licenseValidator;
    ...
    public AuthenticationApiResource(
            ...
            ClientReadPlatformService aClientReadPlatformService, LicenseUsageValidator licenseValidator,
    ...
    public String authenticate(@Parameter(hidden = true) final String apiRequestBodyAsJson,
        ...
        // todo: remove this once we integrate with a payment hub
        if (request.username.equals("momoapi") || request.username.equals("interopUser") || request.username.equals("system")) {
            throw new NoAuthorizationException("This is a system account. Please login with your user account");
        }
        ...
        if (authenticationCheck.isAuthenticated()) {
            ...
            Boolean isMFAEnabled = configurationService.isMFAEnabled();
            this.twoFactorEnabled = isMFAEnabled;
