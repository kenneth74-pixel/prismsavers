...
import org.apache.fineract.extensions.payment.channels.AsynchronousChannel;
...
@Component
@PayChannel(channel = PaymentChannel.HFB_WALLET_IN)
public class WalletToBank extends AsynchronousChannel implements Channel {

    private final PaymentConfiguration configService;
    private final FromJsonHelper jsonHelper;
    private final PaymentClient paymentClient;

    public WalletToBank(PaymentConfiguration configService, FromJsonHelper jsonHelper, PaymentClient paymentClient) {
        super(jsonHelper);
    ...
    public PaymentTransaction createRequest(Long sourceCommand, JsonElement params) {
        ...
        String mobilePhone = this.jsonHelper.extractStringNamed("accountNo", params);
        ...
        result.setAccountTo(bankAccount);
        result.setAccountFrom(mobilePhone);
        return result;
    }
}
