...
@Component
@PayChannel(channel = PaymentChannel.HFB_BANK_EFT)
public class EFT extends SynchronousChannel implements Channel {

    private final PaymentConfiguration configService;
    private final FromJsonHelper jsonHelper;
    private final PaymentClient paymentClient;

    public EFT(PaymentConfiguration configService, FromJsonHelper jsonHelper, PaymentClient paymentClient,
