...
import org.apache.fineract.accounting.journalentry.domain.JournalEntryDomainService;
...
public class JournalEntriesApiResource {
    ...
    public static class AddDescriptionRequest {
    ...
    private final JournalEntryDomainService journalEntryDomainService;
    ...
    public JournalEntriesApiResource(final PlatformSecurityContext context,
            ...
            JournalEntryDomainService journalEntryDomainService,
            final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService,
            final BulkImportWorkbookService bulkImportWorkbookService,
            final BulkImportWorkbookPopulatorService bulkImportWorkbookPopulatorService) {
        this.context = context;
        this.apiRequestParameterHelper = apiRequestParameterHelper;
        this.journalEntryDomainService = journalEntryDomainService;
    ...
    @PUT
    @Path("{entryId}")
    public String addDescription(@PathParam("entryId") @Parameter(description = "entryId") final Long journalEntryId,
            String apiRequestBodyAsJson) {
        JournalEntriesApiResource.AddDescriptionRequest request = new Gson().fromJson(apiRequestBodyAsJson,
                JournalEntriesApiResource.AddDescriptionRequest.class);
        this.context.authenticatedUser().validateHasReadPermission(this.resourceNameForPermission);
        this.journalEntryDomainService.addDescription(request.description, journalEntryId);

        JSONObject result = new JSONObject();
        result.put("updated", "Journal entry description added");
        return this.apiJsonSerializerService.serialize(result);
    }
