    ...
    private static final class LoanProductProvisioningEntryMapper implements RowMapper<LoanProductProvisioningEntryData> {
        ...
        private LoanProductProvisioningEntryMapper() {
            sqlQuery = new StringBuilder().append(
                    ...
                    .append("loan.total_outstanding_derived as outstandingbalance, loan.principal_outstanding_derived as outstandingprincipal, pcd.liability_account, pcd.expense_account from m_loan_repayment_schedule sch")
        ...
        public LoanProductProvisioningEntryData mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            BigDecimal outstandingPrincipal = rs.getBigDecimal("outstandingprincipal");
            ...
            return new LoanProductProvisioningEntryData(historyId, officeId, currentcyCode, productId, categoryId, overdueDays, percentage,
                    outstandingBalance, outstandingPrincipal, liabilityAccountCode, expenseAccountCode, criteriaId);
        }
