...
public class CommandWrapperBuilder {
    ...
    public CommandWrapperBuilder updateApprovalSetting() {
        this.actionName = "UPDATE";
        this.entityName = "APPROVAL_SETTINGS";
        this.entityId = null;
        this.href = "/approvalSetting";
        return this;
    }
    ...
    public CommandWrapperBuilder waivePenaltiesTransaction(final Long loanId) {
        this.actionName = "WAIVE_PENALTIES";
        this.entityName = "LOAN";
        this.entityId = null;
        this.loanId = loanId;
        this.href = "/loans/" + loanId + "/transactions/template?command=waivePenalties";
        return this;
    }
