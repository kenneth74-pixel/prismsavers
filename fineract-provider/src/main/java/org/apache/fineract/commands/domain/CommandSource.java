...
public class CommandSource extends AbstractPersistableCustom {
    ...
    public void markAsPaymentFailed() {
        this.processingResult = CommandProcessingResultType.PAYMENT_FAILED.getValue();
    }

    public void markAsAwaitingPayment() {
        this.processingResult = CommandProcessingResultType.AWAITING_PAYMENT.getValue();
    }

    public void markAsPaymentCompleted() {
        this.processingResult = CommandProcessingResultType.PAYMENT_COMPLETE.getValue();
    }
    ...
    public boolean isMarkedAsAwaitingPayment() {
        return this.processingResult.equals(CommandProcessingResultType.AWAITING_PAYMENT.getValue());
    }

    public boolean isMarkedAsPaymentCompleted() {
        return this.processingResult.equals(CommandProcessingResultType.PAYMENT_COMPLETE.getValue());
    }
