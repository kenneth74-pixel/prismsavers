...
public final class AuditData {
    ...
    public AuditData(final Long id, final String actionName, final String entityName, final Long resourceId, final Long subresourceId,
            final String maker, final ZonedDateTime madeOnDate, final String processingResult, final String commandAsJson,
            final String officeName, final String groupLevelName, final String groupName, final String clientName,
            final String loanAccountNo, final String savingsAccountNo, final Long clientId, final Long loanId, final String url) {
