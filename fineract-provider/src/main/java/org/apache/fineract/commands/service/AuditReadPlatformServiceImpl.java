...
public class AuditReadPlatformServiceImpl implements AuditReadPlatformService {
    ...
    private static final Set<String> supportedOrderByValues = new HashSet<>(
            Arrays.asList("id", "actionName", "entityName", "resourceId", "subresourceId", "madeOnDate", "officeName", "groupName",
                    "clientName", "loanAccountNo", "savingsAccountNo", "clientId", "loanId", "maker", "processingResult"));
    ...
    private static final class AuditMapper implements RowMapper<AuditData> {
        ...
        public String schema(final boolean includeJson, final String hierarchy) {
            ...
            String partSql = " aud.id as id, aud.action_name as actionName, aud.entity_name as entityName,"
                    ...
                    + "ev.enum_message_property as processingResult " + commandAsJsonString + ", "
                    ...
                    + " left join m_appuser mk on mk.id = aud.maker_id" + " left join m_office o on o.id = aud.office_id"
        ...
        public AuditData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return new AuditData(id, actionName, entityName, resourceId, subresourceId, maker, madeOnDate, processingResult, commandAsJson,
                    officeName, groupLevelName, groupName, clientName, loanAccountNo, savingsAccountNo, clientId, loanId, resourceGetUrl);
        }
    }
