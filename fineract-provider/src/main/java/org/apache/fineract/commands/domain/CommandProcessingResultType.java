...
public enum CommandProcessingResultType {
    ...
    REJECTED(3, "commandProcessingResultType.rejected"), AWAITING_PAYMENT(4,
            "commandProcessingResultType.awaiting.payment"), PAYMENT_FAILED(5,
                    "commandProcessingResultType.payment.failed"), PAYMENT_COMPLETE(6, "commandProcessingResultType.payment.complete");
    ...
    public static CommandProcessingResultType fromInt(final Integer typeValue) {
        return switch (typeValue) {
            case 1 -> PROCESSED;
            case 2 -> AWAITING_APPROVAL;
            case 3 -> REJECTED;
            case 4 -> AWAITING_PAYMENT;
            case 5 -> PAYMENT_FAILED;
            case 6 -> PAYMENT_COMPLETE;
            default -> CommandProcessingResultType.INVALID;
        };
    }
}
