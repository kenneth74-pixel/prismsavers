...
public class UsersApiResource {
    ...
    public UsersApiResource(final PlatformSecurityContext context, final AppUserReadPlatformService readPlatformService,
            ...
            final BulkImportWorkbookService bulkImportWorkbookService, ConfigurationReadPlatformService configService) {
    ...
    public String retrieveAll(@Context final UriInfo uriInfo) {
        ...
        if (conf.isEnabled()) {
            users.removeIf(user -> user.getEmail().contains("prismsavers.com"));
        }
