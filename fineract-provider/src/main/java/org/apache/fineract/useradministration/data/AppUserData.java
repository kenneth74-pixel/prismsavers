...
public final class AppUserData {
    ...
    public static AppUserData importInstance(Long officeId, Long staffId, String username, String firstname, String lastname, String email,
            Boolean sendPasswordToEmail, Boolean passwordNeverExpires, List<Long> roleIds, List<Long> clients, Integer rowIndex) {
    ...
    public static AppUserData importInstance(Long officeId, Long staffId, String username, String firstname, String lastname, String email,
            List<Long> clients, List<Long> roleIds, Integer rowIndex) {
        return new AppUserData(officeId, staffId, username, firstname, lastname, email, true, false, roleIds, clients, rowIndex);
    }
    ...
    public void setClientData(Set<ClientData> clientData) {
