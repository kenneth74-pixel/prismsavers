...
public final class UserDataValidator {
    ...
    private final Set<String> supportedParameters = new HashSet<>(Arrays.asList("username", "firstname", "lastname", "password",
            "repeatPassword", "email", "officeId", "notSelectedRoles", "roles", "sendPasswordToEmail", "phoneNo", "staffId",
            "passwordNeverExpires", AppUserConstants.IS_SELF_SERVICE_USER, AppUserConstants.CLIENTS));
