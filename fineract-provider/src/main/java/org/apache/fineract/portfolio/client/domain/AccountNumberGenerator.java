...
public class AccountNumberGenerator {
    ...
    private static final String IS_CLIENT_AUTHENTICATED = String.valueOf(true);
    ...
    public String generate(Client client, AccountNumberFormat accountNumberFormat, Boolean isClientAuthenticated) {
        ...
        propertyMap.put(IS_CLIENT_AUTHENTICATED, String.valueOf(isClientAuthenticated));
    ...
    private String generateAccountNumber(Map<String, String> propertyMap, AccountNumberFormat accountNumberFormat) {
        ...
        GlobalConfigurationPropertyData customLength = null;
        GlobalConfigurationPropertyData randomAccountNumber = null;

        if (propertyMap.containsKey(IS_CLIENT_AUTHENTICATED)) {
            isClientAuthenticated = Boolean.parseBoolean(propertyMap.get(IS_CLIENT_AUTHENTICATED));
        }

        // find if the custom length is defined
        if (isClientAuthenticated) {
            customLength = this.configurationReadPlatformService.retrieveGlobalConfiguration("custom-account-number-length");
            ...
            randomAccountNumber = this.configurationReadPlatformService.retrieveGlobalConfiguration("random-account-number");
        ...
        if (isClientAuthenticated && randomAccountNumber.isEnabled()) { // calling the main function itself until new
                                                                        // randomNo.
