    ...
    private static final class ChargeMapper implements RowMapper<ChargeData> {
        ...
        public String chargeSchema() {
            return "c.id as id, c.name as name, c.amount as amount, c.currency_code as currencyCode, "
                    ...
                    + "c.is_active as active,c.is_sms_charge as smsCharge, c.is_free_withdrawal as isFreeWithdrawal, c.free_withdrawal_charge_frequency as freeWithdrawalChargeFrequency, c.restart_frequency as restartFrequency, c.restart_frequency_enum as restartFrequencyEnum,"
        ...
        public ChargeData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final boolean smsCharge = rs.getBoolean("smsCharge");
