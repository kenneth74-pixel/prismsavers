...
public interface LoanRepository extends JpaRepository<Loan, Long>, JpaSpecificationExecutor<Loan> {
    ...
    @Query("select loan from Loan loan where loan.id = :id and loan.loanStatus=300")
    Loan findActiveLoanById(@Param("id") Long id);
    ...
    @Query("select loan from Loan loan where loan.externalId = :externalId and loan.loanStatus=300")
    Loan findActiveLoanByExternalId(@Param("externalId") String externalId);
}
