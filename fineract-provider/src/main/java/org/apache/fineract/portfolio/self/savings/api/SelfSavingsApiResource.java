...
public class SelfSavingsApiResource {
    ...
    @POST
    @Path("/{savingId}/transaction")
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    public String makeDeposit(@PathParam("savingId") @Parameter(description = "savingId") final Long savingId,
            @Parameter(hidden = true) final String apiRequestBodyAsJson) {
        validateAppuserSavingsAccountMapping(savingId);
        this.dataValidator.validateHasPaymentIntegration(apiRequestBodyAsJson);
        return this.savingsAccountTransactionsApiResource.transaction(savingId, "deposit", apiRequestBodyAsJson);
    }
