...
public class ClientsApiResource {
    ...
    public String retrieveOne(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
            ...
            @DefaultValue("false") @QueryParam("staffInSelectedOfficeOnly") @Parameter(description = "staffInSelectedOfficeOnly") final boolean staffInSelectedOfficeOnly) {
        return this.retrieveOne(clientId, uriInfo, staffInSelectedOfficeOnly, false);
    }

    public String retrieveOne(Long clientId, UriInfo uriInfo, boolean staffInSelectedOfficeOnly, boolean isSelfUser) {
        if (!isSelfUser) {
            this.context.authenticatedUser().validateHasReadPermission(ClientApiConstants.CLIENT_RESOURCE_NAME);
        }
    ...
    public String retrieveAssociatedAccounts(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return retrieveAssociatedAccounts(clientId, uriInfo, false);
    }

    public String retrieveAssociatedAccounts(Long clientId, UriInfo uriInfo, boolean isSelfUser) {
        if (!isSelfUser) {
            this.context.authenticatedUser().validateHasReadPermission(ClientApiConstants.CLIENT_RESOURCE_NAME);
        }
    ...
    public String retrieveObligeeDetails(@PathParam("clientId") final Long clientId, @Context final UriInfo uriInfo) {
        return retrieveObligeeDetails(clientId, false);
    }

    public String retrieveObligeeDetails(Long clientId, boolean isSelfUser) {
        if (!isSelfUser) {
            this.context.authenticatedUser().validateHasReadPermission(ClientApiConstants.CLIENT_RESOURCE_NAME);
        }
