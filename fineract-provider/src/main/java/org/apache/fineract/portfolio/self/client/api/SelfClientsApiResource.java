...
import org.apache.fineract.portfolio.self.client.service.ClientTransactionsReadService;
...
public class SelfClientsApiResource {
    ...
    private final ClientTransactionsReadService clientTransactionsReadService;
    private final ApiRequestParameterHelper apiRequestParameterHelper;
    private final ToApiJsonSerializer<TransactionsSummaryCollectionData> toApiJsonSerializer;
    ...
    public SelfClientsApiResource(final PlatformSecurityContext context, final ClientsApiResource clientApiResource,
            ...
            ClientTransactionsReadService clientTransactionsReadService, ApiRequestParameterHelper apiRequestParameterHelper,
            ToApiJsonSerializer<TransactionsSummaryCollectionData> toApiJsonSerializer) {
        ...
        this.clientTransactionsReadService = clientTransactionsReadService;
    ...
    public String retrieveOne(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return this.clientApiResource.retrieveOne(clientId, uriInfo, staffInSelectedOfficeOnly, true);
    }
    ...
    public String retrieveAssociatedAccounts(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return this.clientApiResource.retrieveAssociatedAccounts(clientId, uriInfo, true);
    }
    ...
    public Response retrieveImage(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        validateAppuserClientsMapping(clientId);
        return this.imagesApiResource.retrieveImage("clients", clientId, maxWidth, maxHeight, output, MediaType.TEXT_PLAIN, true);
    }
    ...
    public String retrieveAllClientCharges(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return this.clientChargesApiResource.retrieveAllClientCharges(clientId, chargeStatus, pendingPayment, uriInfo, limit, offset, true);
    }
    ...
    public String retrieveClientCharge(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return this.clientChargesApiResource.retrieveClientCharge(clientId, chargeId, uriInfo, true);
    }
    ...
    public String retrieveAllClientTransactions(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        validateAppuserClientsMapping(clientId);
        final TransactionsSummaryCollectionData clientTransactions = this.clientTransactionsReadService.retrieveTransactions(clientId);
        final Set<String> CLIENT_TRANSACTION_DATA_PARAMETERS = new HashSet<>(
                Arrays.asList("savingsTransactions", "loanTransactions", "clientTransactions"));
        final ApiRequestJsonSerializationSettings settings = this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
        return this.toApiJsonSerializer.serialize(settings, clientTransactions, CLIENT_TRANSACTION_DATA_PARAMETERS);
    }
    ...
    public String retrieveClientTransaction(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return this.clientTransactionsApiResource.retrieveClientTransaction(clientId, transactionId, uriInfo, true);
    }
    ...
    public String retrieveObligeeDetails(@PathParam("clientId") final Long clientId, @Context final UriInfo uriInfo) {
        ...
        return this.clientApiResource.retrieveObligeeDetails(clientId, true);
    }

    @GET
    @Path("{clientId}/recenttransactions")
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "List Only Client Transactions. Legacy endpoint used only in native Android self-service mobile app", description = "The list capability of client transaction can support pagination.\n\n"
            + "Example Requests:\n" + "\n" + "self/clients/189/recenttransactions\n\n"
            + "self/clients/189/recenttransactions?offset=10&limit=50")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = SelfClientsApiResourceSwagger.GetSelfClientsClientIdTransactionsResponse.class))) })
    public String retrieveAllClientRecentTransactions(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
            @Context final UriInfo uriInfo, @QueryParam("offset") @Parameter(description = "offset") final Integer offset,
            @QueryParam("limit") @Parameter(description = "limit") final Integer limit) {
