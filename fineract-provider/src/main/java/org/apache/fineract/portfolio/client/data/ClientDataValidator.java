...
public final class ClientDataValidator {
    ...
    public ClientDataValidator(final FromJsonHelper fromApiJsonHelper,
            final ConfigurationReadPlatformService configurationReadPlatformService, LicenseUsageValidator licenseUsageValidator) {
    ...
    public void validateForCreate(final String json) {
        ...
        licenseUsageValidator.validateAdditionalClient();
