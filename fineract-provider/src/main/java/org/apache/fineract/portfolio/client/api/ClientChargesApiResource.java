...
public class ClientChargesApiResource {
    ...
    public String retrieveAllClientCharges(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return retrieveAllClientCharges(clientId, chargeStatus, pendingPayment, uriInfo, limit, offset, false);
    }

    public String retrieveAllClientCharges(Long clientId, String chargeStatus, Boolean pendingPayment, UriInfo uriInfo, Integer limit,
            Integer offset, boolean isSelfUser) {
        if (!isSelfUser) {
    ...
    public String retrieveClientCharge(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
        ...
        return retrieveClientCharge(clientId, chargeId, uriInfo, false);
    }

    public String retrieveClientCharge(Long clientId, Long chargeId, UriInfo uriInfo, boolean isSelfUser) {
        if (!isSelfUser) {
            this.context.authenticatedUser().validateHasReadPermission(ClientApiConstants.CLIENT_CHARGES_RESOURCE_NAME);
        }
        ...
        if (!associationParameters.isEmpty()) {
            if (associationParameters.contains("all")) {
                associationParameters.add(ClientApiConstants.CLIENT_CHARGE_ASSOCIATIONS_TRANSACTIONS);
            }
