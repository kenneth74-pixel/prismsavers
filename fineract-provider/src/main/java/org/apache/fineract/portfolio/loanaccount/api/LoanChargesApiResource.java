...
public class LoanChargesApiResource {
    ...
    public String retrieveAllLoanCharges(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId,
        ...
        return retrieveAllLoanCharges(loanId, uriInfo, false);
    }

    public String retrieveAllLoanCharges(Long loanId, UriInfo uriInfo, boolean isSelfUser) {
        if (!isSelfUser) {
    ...
    public String retrieveLoanCharge(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId,
        ...
        return retrieveLoanCharge(loanId, loanChargeId, uriInfo, false);
    }

    public String retrieveLoanCharge(Long loanId, Long loanChargeId, UriInfo uriInfo, boolean isSelfUser) {
        if (!isSelfUser) {
            this.context.authenticatedUser().validateHasReadPermission(this.resourceNameForPermissions);
        }
