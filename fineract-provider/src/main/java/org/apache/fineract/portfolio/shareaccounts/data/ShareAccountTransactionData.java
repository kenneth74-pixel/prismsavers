...
public class ShareAccountTransactionData implements Serializable {
    ...
    public static ShareAccountTransactionData importInstance(final Long id, final Long accountId, final LocalDate purchasedDate,
            final Long numberOfShares, final BigDecimal purchasedPrice, final EnumOptionData status, final EnumOptionData type,
            final BigDecimal amount, final BigDecimal chargeAmount, final BigDecimal amountPaid) {
        return new ShareAccountTransactionData(id, accountId, purchasedDate, numberOfShares, purchasedPrice, status, type, amount,
