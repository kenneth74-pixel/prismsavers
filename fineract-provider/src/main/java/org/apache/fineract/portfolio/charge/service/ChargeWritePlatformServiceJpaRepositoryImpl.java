...
public class ChargeWritePlatformServiceJpaRepositoryImpl implements ChargeWritePlatformService {
    ...
    public CommandProcessingResult updateCharge(final Long chargeId, final JsonCommand command) {
        ...
        try {
            ...
            final String smsChargeParamName = "smsCharge";
            if (changes.containsKey(smsChargeParamName)) {
                final boolean isSmsCharge = (boolean) changes.get(smsChargeParamName);
                chargeForUpdate.setSmsCharge(isSmsCharge);
            }
