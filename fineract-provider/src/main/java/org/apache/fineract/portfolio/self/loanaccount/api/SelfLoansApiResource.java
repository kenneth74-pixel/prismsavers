...
public class SelfLoansApiResource {
    ...
    public String retrieveLoan(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId, @Context final UriInfo uriInfo) {
        ...
        return this.loansApiResource.retrieveLoan(loanId, staffInSelectedOfficeOnly, uriInfo, true);
    }
    ...
    public String retrieveTransaction(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId,
        ...
        return this.loanTransactionsApiResource.retrieveTransaction(loanId, transactionId, uriInfo, true);
    }
    ...
    public String retrieveAllLoanCharges(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId,
        ...
        return this.loanChargesApiResource.retrieveAllLoanCharges(loanId, uriInfo, true);
    }
    ...
    public String retrieveLoanCharge(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId,
        ...
        return this.loanChargesApiResource.retrieveLoanCharge(loanId, loanChargeId, uriInfo, true);
    }
    ...
    @POST
    @Path("{loanId}/transaction")
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    public String makeRepayment(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId,
            @Parameter(hidden = true) final String apiRequestBodyAsJson) {
        validateAppuserLoanMapping(loanId);
        this.dataValidator.validateHasPaymentIntegration(apiRequestBodyAsJson);
        return this.loanTransactionsApiResource.executeLoanTransaction(loanId, "repayment", apiRequestBodyAsJson);
    }
    ...
    public String retrieveGuarantorDetails(@PathParam("loanId") final Long loanId, @Context final UriInfo uriInfo) {
        ...
        validateAppuserLoanMapping(loanId);
        return this.guarantorsApiResource.retrieveGuarantorDetails(uriInfo, loanId, true);
    }
